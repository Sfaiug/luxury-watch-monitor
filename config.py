...
class AppConfig:
    ...
    # Data retention
    max_seen_items_per_site: int = int(os.getenv('MAX_SEEN_ITEMS_PER_SITE', '2000'))
    ...
    force_gc_every_n_cycles: int = int(os.getenv('FORCE_GC_EVERY_N_CYCLES', '5'))
    max_session_history_entries: int = int(os.getenv('MAX_SESSION_HISTORY_ENTRIES', '500'))
